  ...
  try {
    ...
    const r = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: "Analyse these YouTube comments and return ONLY valid JSON with no markdown or extra text:\n\n" + sample + "\n\nReturn exactly:\n{\"positive\":70,\"neutral\":20,\"negative\":10,\"themes\":[{\"theme\":\"name\",\"sentiment\":\"positive\",\"count\":5,\"examples\":[\"quote1\",\"quote2\",\"quote3\"]}],\"summary\":\"2-3 sentences\",\"quickWins\":[\"action1\",\"action2\",\"action3\"]}"
        }]
      })
    });
    const d = await r.json();
